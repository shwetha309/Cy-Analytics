...
public class ActivityWithinRegionDriver {
	...
	final Serde < RegionSummary > rsummarySerde = Serdes.serdeFrom(rsummarySerializer, rsummaryDeserializer); 
        ...
        builder.addSource("Region Data Process", stringDeserializer, rsummaryDeserializer,"RegionDataStream")
                       .addProcessor("act-process", ActivityWithinProcess::new, "Region Data Process")
                       .addStateStore(Stores.create("RegionStore").withStringKeys()
                       ...
                       .addSink("sink-2", "ActivityWithinRegionStream", stringSerializer, rsummarySerializer, "act-process");
